...
**Hierarchically assigned IP** => Suppose there is an organization XYZ (having reserved ip starting like - 10.x.x.x), and it's newYork branch has IP which starts like(10.20.x.x) & delhi IP like (10.30.x.x). Inside Delhi & NY we can have further hierarchies based on teams(sales, engineering)
