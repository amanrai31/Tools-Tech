...
Before NETWORK transferring data required portable media (Disk, CD, penDrives etc)

***Network(n/w) -*** Host are connected to each other through n/w. Logical grouping of hosts that require similar connectivity.

**Internet is just newtwork of networks**
