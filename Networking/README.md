...
Every host on the internet has IP address. **IP is the  identity for each host on n/w.** When a data packet is send OR recived, it has the source & destination IPs both.
